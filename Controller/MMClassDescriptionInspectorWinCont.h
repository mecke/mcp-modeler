//
//  MMClassDescriptionInspectorWinCont.h
//  MCPModeler
//
...
@interface MMClassDescriptionInspectorWinCont : NSWindowController {
	IBOutlet MMInspectorViewClassDescription    *classDescriptionInspectorView;
	
//	MCPClassDescription                          *classDescription;     // Weak reference (no retain).
}
